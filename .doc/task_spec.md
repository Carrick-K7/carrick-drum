...
| 编号 | 目标 | 交付件 | 状态 | 截止 |
|:---:|:---|:---|:---:|:---:|
| M1 | 技术验证：单首教学可运行 | 判定系统, 1首练习曲, 基础UI | ⏳ 待开发 | 待定 |
| M2 | 内容扩展：10首曲库可用 | 10首练习曲数据, 曲库浏览 | ⏳ 待开发 | 待定 |
| M3 | 体验优化：解锁+评分+流畅 | 进度解锁, 游戏评分, 性能优化 | ⏳ 待开发 | 待定 |
| M4 | 部署上线：生产环境可访问 | 生产部署, 域名配置, Carrick验收 | ⏳ 待开发 | 待定 |

**当前里程碑:** M1 技术验证 ⏳

**Milestone 设计原则：**
- M1-M3：按时间盒（每阶段2周，用户价值驱动）
- M4：部署上线（风险驱动，独立验收）
